---
title: "Behind the Scenes -- In-depth Analysis"
...
You may notice more variables d on the VI plot than coefficeints above.  That is because the lasso approach regularized and shrunk the leadt contributing variables coefficients to basically zero, as seen with these additional variables being quite unimportant to predicting score outcome.  
...
- data cleaning took a while.....ddi a lot of new vars creation and transformation
