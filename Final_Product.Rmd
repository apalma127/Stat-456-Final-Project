...
=======
```{r include=FALSE}
>>>>>>> 37022aea832c104d9849324ac9c7d199478e1471
# qbr // score
...
drive_summary_data %>%
   ggplot(aes(y = qbr_total, x = completion_perc)) +
   geom_point() +
   geom_smooth()
...
Above, you can see the logistic regression model output for all of our variables and their coefficients.  The coefficients have been transformed, by exponentiation, to make them more interpretable.    
...
Famous Two Min Drill in CFB CFP Finals:
...
For the reasons above, we feel very comfortbale with the highly accurate and interpretable Lasso Log Regression.  To ensure we weren't missing a homerun with any other model types, we also explored modeling with two different decision tree applications.  
...
We see no potenital harm for this analysis.  ________
