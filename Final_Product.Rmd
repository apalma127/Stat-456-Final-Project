...
A coefficent value of one indicates no change.
...
what is a boost tune for a tree? what is being tuned?
...
what are the metrics? how do they compare
...
wrap up ... why did we not go with a boosted model?
...
When factoring in our desired outcome with standrd coefficents, and taking into account the much higher true positive rate in the log reg output, we have much more confidence in our selection of the logisitc regression model and stand by our analysis as appropriate  
...
We see no potential harm for this analysis.  We were very open about how we performed our analysis with the data and goal of the project being benign in scope.  We see no negative uses of this data and see it only having possible upside with more stats reliance.  Better equipped teams and offenses will lead to more in-game action and better ratings.  
